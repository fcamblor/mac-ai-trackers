...
4. `planned` — [Usage details popover](usage-details-popover.md) — open a polished popover on click with one card per account showing progress bars, reset dates, theoretical pace, and pay-as-you-go amounts.
