...
struct UsageDataRefreshIntervalView: View {
    private static let pollingStepsMinutes: [Int] = [1, 2, 3, 5, 10, 20, 30]
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            .frame(height: 16)
            Text("How often usage data is fetched from the Vendor API.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
